...
$sql = "update part_time_job_inf set user_id = :user_id, job_name = :job_name, hourly_wage = :hourly_wage, cutoff_day = :cutoff_day, payment_day=:payment_day, mid_wage=:mid_wage, start_mid_time=:start_mid_time, end_mid_time = :end_mid_time where user_id = :user_id and job_name = :pre_name";
